...
& $msbuildPath "NowPlaying.sln" /t:Build /p:Configuration=$Configuration /p:Platform=$Platform /m /v:minimal
...
if ($LASTEXITCODE -eq 0) {
    ...
    $addonName = if ($addonMeta -and $addonMeta.name) { $addonMeta.name } else { "NowPlaying" }
